...
DatabaseException::DatabaseException(const string& text, const int& line, const string& source) : Exception(text, line, source) {};
InvalidArgumentException::InvalidArgumentException(const string& text, const int& line, const string& source) : Exception(text, line, source) {};